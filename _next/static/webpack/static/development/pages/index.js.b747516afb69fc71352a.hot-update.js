...
/*!*******************************!*\
  !*** ./data/PlaylistStore.js ***!
  \*******************************/
/*! exports provided: addTag, removeTag, playlists$, tagsByTrack$, tracksById$, filteredTracks$, default */
...
function savePlaylistsToDb(_x6) {
...
var playlistFetches$ = xstream__WEBPACK_IMPORTED_MODULE_2___default.a.combine(validFetch$, intervalAfterValidFetch).map(function (_ref9) {
...
function fetchPlaylistTracks(_x8, _x9, _x10) {
...
function _fetchPlaylistTracks() {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee11(fetch, playlistId, url) {
    var resp, _ref22, next, items, ret;
...
function fetchAndSavePlaylistTracks(_x11, _x12, _x13, _x14) {
...
playlistFetches$.compose(xstream_extra_sampleCombine__WEBPACK_IMPORTED_MODULE_4___default()(playlistTracks$, _UserStore__WEBPACK_IMPORTED_MODULE_8__["fetch$"])).addListener({
  next: function next(_ref12) {
    var _ref13 = _slicedToArray(_ref12, 3),
        playlists = _ref13[0],
        playlistTracks = _ref13[1],
        fetch = _ref13[2];
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          return _context6.abrupt("return", lodash__WEBPACK_IMPORTED_MODULE_6___default.a.keyBy(tracks, "uri"));
...
var filteredTracks$ = xstream__WEBPACK_IMPORTED_MODULE_2___default.a.combine(_UIStore__WEBPACK_IMPORTED_MODULE_9__["selectedPlaylist$"], playlistTracks$, allTracks$).map(function (_ref17) {
  var _ref18 = _slicedToArray(_ref17, 3),
      selectedPlaylist = _ref18[0],
...
function () {
  function PlaylistStore() {
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7(trackUri, playlistId) {
        var resp;
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee8(trackUri, playlistName) {
        var resp, playlist;
...
//# sourceMappingURL=index.js.b747516afb69fc71352a.hot-update.js.map