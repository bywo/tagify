...
if (global.window) {
  window.playlist = _data_PlaylistStore__WEBPACK_IMPORTED_MODULE_6__;
}
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_util_recompose__WEBPACK_IMPORTED_MODULE_5__["componentFromStream"])(function () {
  var _createEventHandler = Object(_util_recompose__WEBPACK_IMPORTED_MODULE_5__["createEventHandler"])(),
      onSidebarResize = _createEventHandler.handler,
      sidebarDeltasInput$ = _createEventHandler.stream;

  _data_UIStore__WEBPACK_IMPORTED_MODULE_7__["sidebarDeltas$"].imitate(sidebarDeltasInput$);

  var _createEventHandler2 = Object(_util_recompose__WEBPACK_IMPORTED_MODULE_5__["createEventHandler"])(),
      onSelectPlaylist = _createEventHandler2.handler,
      selectedPlaylistInput$ = _createEventHandler2.stream;

  _data_UIStore__WEBPACK_IMPORTED_MODULE_7__["selectedPlaylistChanges$"].imitate(selectedPlaylistInput$);
  return xstream__WEBPACK_IMPORTED_MODULE_1___default.a.combine(_data_UIStore__WEBPACK_IMPORTED_MODULE_7__["sidebarWidth$"], _data_PlaylistStore__WEBPACK_IMPORTED_MODULE_6__["playlists$"], _data_UIStore__WEBPACK_IMPORTED_MODULE_7__["selectedPlaylist$"]).map(function (_ref) {
...
//# sourceMappingURL=index.js.e5770783eea35553fd3d.hot-update.js.map