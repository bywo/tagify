...
}()).map(xstream__WEBPACK_IMPORTED_MODULE_1___default.a.fromPromise).compose(xstream_extra_flattenConcurrently__WEBPACK_IMPORTED_MODULE_4___default.a);
...
}()).map(xstream__WEBPACK_IMPORTED_MODULE_1___default.a.fromPromise).compose(xstream_extra_flattenConcurrently__WEBPACK_IMPORTED_MODULE_4___default.a).map(function (_ref12) {
...
function _fetchPlaylistTracks() {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee11(fetch, playlistId, url) {
    var resp, _ref27, next, items, ret;
...
var filteredTracks$ = xstream__WEBPACK_IMPORTED_MODULE_1___default.a.combine(_UIStore__WEBPACK_IMPORTED_MODULE_8__["selectedPlaylist$"], playlistTracks$, allTracks$).map(function (_ref22) {
...
}).combine(_UIStore__WEBPACK_IMPORTED_MODULE_8__["searchQuery$"]).map(function (_ref24) {
  var _ref25 = _slicedToArray(_ref24, 2),
      trackIds = _ref25[0],
      searchQuery = _ref25[1];
...
//# sourceMappingURL=callback.js.485bf5d24a27318011ed.hot-update.js.map