          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                // );
                // if (resp.ok) {
                _this.tracksByPlaylist[playlistId].push(_this.tracksById[trackUri]); // } else {
                // }
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Object(_util_fetch__WEBPACK_IMPORTED_MODULE_1__["default"])("https://api.spotify.com/v1/users/{user_id}/playlists", {
                  method: "POST"
                });
...
//# sourceMappingURL=index.js.202865b4f54f422328a9.hot-update.js.map