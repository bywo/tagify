        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_util_fetch__WEBPACK_IMPORTED_MODULE_1__["default"])("https://api.spotify.com/v1/playlists/".concat(playlistId, "/tracks"), {
                  method: "POST",
                  body: JSON.stringify({
                    uris: [trackUri]
                  })
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 8:
                ...
                (_this$playlists = this.playlists).push.apply(_this$playlists, _toConsumableArray(items));
...
//# sourceMappingURL=index.js.0207e789ebe26ec15c81.hot-update.js.map