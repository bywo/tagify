...
var createdTags$ = createAndAddTagEvents$.compose(xstream_extra_sampleCombine__WEBPACK_IMPORTED_MODULE_4___default()(_UserStore__WEBPACK_IMPORTED_MODULE_8__["fetch$"])).map(
/*#__PURE__*/
function () {
  var _ref10 = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(_ref9) {
    var _ref11, _ref11$, trackId, playlistName, fetch, playlist;

    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _ref11 = _slicedToArray(_ref9, 2), _ref11$ = _ref11[0], trackId = _ref11$.trackId, playlistName = _ref11$.playlistName, fetch = _ref11[1];
            _context5.next = 3;
            return _api__WEBPACK_IMPORTED_MODULE_11__["createPlaylist"](fetch, playlistName);
...
}()).map(xstream__WEBPACK_IMPORTED_MODULE_2___default.a.fromPromise).compose(xstream_extra_flattenConcurrently__WEBPACK_IMPORTED_MODULE_5___default.a); // .map(({trackId, playlist}) => {
...
createdTags$.addListener({
  next: function () {
    ...
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6(_ref12) {
      var trackId, playlist;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              trackId = _ref12.trackId, playlist = _ref12.playlist;
...
var playlistFetches$ = xstream__WEBPACK_IMPORTED_MODULE_2___default.a.combine(validFetch$, intervalAfterValidFetch).map(function (_ref13) {
...
function _fetchPlaylistTracks() {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee11(fetch, playlistId, url) {
    var resp, _ref24, next, items, ret;
...
var filteredTracks$ = xstream__WEBPACK_IMPORTED_MODULE_2___default.a.combine(_UIStore__WEBPACK_IMPORTED_MODULE_9__["selectedPlaylist$"], playlistTracks$, allTracks$).map(function (_ref21) {
  var _ref22 = _slicedToArray(_ref21, 3),
      selectedPlaylist = _ref22[0],
      playlistTracks = _ref22[1],
      allTracks = _ref22[2];
...
function _createPlaylist() {
  ...
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(fetch, playlistName) {
    var resp;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://api.spotify.com/v1/users/".concat(this.user.id, "/playlists"), {
              method: "POST",
              body: JSON.stringify({
                name: playlistName,
...
//# sourceMappingURL=index.js.ba51a1f0206e7534197b.hot-update.js.map