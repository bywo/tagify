...
function (_React$Component) {
  ...
  function TableRow() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseEnter", function (e) {
      console.log("mouseenter", e.target, e.currentTarget, e.relatedTarget); // if (e.target === this.root) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMouseLeave", function (e) {
      console.log("mouseleave", e.target, e.currentTarget, e.relatedTarget); // if (e.target === this.root) {
  ...
  _createClass(TableRow, [{
    ...
    value: function componentDidMount() {
      this.root.addEventListener("mouseenter", function (e) {
        console.log("native mouseenter", e.target, e.currentTarget);
      });
      this.root.addEventListener("mouseleave", function (e) {
        console.log("native mouseleave", e.target, e.currentTarget);
      });
    }
  }, {
...
//# sourceMappingURL=index.js.9f6bfa5fc0a4723838d7.hot-update.js.map